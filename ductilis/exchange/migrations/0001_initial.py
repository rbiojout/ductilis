    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticks', to='exchange.Provider')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='ticker', to='company.Company')),
                ('exchange', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='tickers', to='exchange.Exchange')),
            ],
            options={
                'ordering': ['symbol'],
            },
        ...
        migrations.AddField(
            model_name='tick',
            name='ticker',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticks', to='exchange.Ticker'),
        ),
        migrations.AlterUniqueTogether(
            name='tick',
            unique_together={('ticker', 'provider', 'date')},
        ),
    ]
