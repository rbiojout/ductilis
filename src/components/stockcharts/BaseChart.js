...
class BaseChart extends React.Component {
	...
	render() {
		...
		const margin = { left: 40, right: 55, top: 20, bottom: 30 };
		const height = 420;
		...
		return (
			...
			>
				<Chart id={0} yExtents={d => [d.high, d.low]}>
					...
					{/* ADD THE CORRECT CHART HERE */}
					{this.props.serieChart}
					{/* END ADD THE CORRECT CHART HERE */}
...
BaseChart = fitWidth(BaseChart);

export  { canvasGradient, BaseChart };