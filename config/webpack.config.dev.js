...
// CHANGED from const publicPath = '/';
const publicPath = 'http://localhost:3000/';
// `publicUrl` is just like `publicPath`, but we will provide it to our app
// as %PUBLIC_URL% in `index.html` and `process.env.PUBLIC_URL` in JavaScript.
// Omit trailing slash as %PUBLIC_PATH%/xyz looks better than %PUBLIC_PATH%xyz.
// CHANGED from const publicUrl = '';
...
// we want to manage multiple entries
// so we have a dict with keys
// cf https://github.com/webpack/docs/wiki/multiple-entry-points
// make sure to respect order to have hot reloading working
const webpack_entries = [require.resolve('webpack-dev-server/client') + '?http://localhost:3000',
                          require.resolve('webpack/hot/dev-server')];
const entries = Object.assign({}, paths.entries);
...
module.exports = {
  ...
  entry: {
    ...
    // require.resolve('webpack/hot/dev-server'),
    webpack: require.resolve('webpack-dev-server/client') + '?http://localhost:3000',
  ...
  */
  ...
  optimization: {
    /* REMOVED DUE TO PROBLEMS WITH Django-webpack
